...
int main (int argc, char **argv) {
	...
	glutDisplayFunc(displayTriangle); // Tell GLUT to use the method "display" for rendering
	glutIdleFunc(displayTriangle); // Tell GLUT to use the method "display" as our idle method as well
